<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="HTTPCanvas.WebForm1" %>
    ...
    <script type="text/javascript">
        ...
        function chkin()
        {
            if (document.getElementById("H2").value != "") //遠端傳來繪圖動作
            {
                ...
                for (var i = 1; i < z.length - 1; i++) //依座標陣列連續會制線段
                {
                    var q = z[i].split(","); //拆解座標點的X和Y座標
...
<body onload="init()">
    <form id="form1" runat="server">
        ...
        <p>
            ...
            畫給：<asp:TextBox ID="TextBox_ToWhom" runat="server"></asp:TextBox>
            看</p>
    </form>
    <canvas id="m" width="500" height="400"
        onmousedown="md()" onmousemove="mv()" onmouseup="mup()" style="border: thin solid #000000"></canvas>
</body>
</html>
