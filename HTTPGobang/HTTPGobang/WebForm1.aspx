<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="HTTPGobang.WebForm1" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function init()
        {
            G = C.getContext("2d"); //建立繪圖物件(對應於canvas物件 id=C)
            reset(); //重設棋盤
        }
        //重設棋盤
        function reset()
            ...
            else //下棋訊息
            {
                ...
                switch (st)
                {
                    ...
                    case -1: //對手下棋
                        ...
                        {
                            BD.style.backgroundColor = "white"; //棋盤變白色
                            BD.style.cursor = "default"; //游標改變為預設值
                            Msg.innerHTML = "到你了!" //下棋序提示訊息
                            Q = true; //換我方下棋
                            clearInterval(T); //暫停監聽(避免遠端訊息打擾我下棋)
                        }
                        break;
                }
            }
...
<body onload="init()">
    <form id="form1" runat="server">
        ...
        <p>
            我是：<asp:TextBox ID="TextBox_Me" runat="server"></asp:TextBox>
            在跟：<asp:TextBox ID="TextBox_To" runat="server"></asp:TextBox>
            玩 <asp:Button ID="Button_Restart" runat="server" Text="重玩" OnClick="Button_Restart_Click" />
        </p>
    </form>
    </body>
</html>
